...
- Any research question that bends existing study types
...
- **Concerns**: What worries them, what questions they'd ask, what would change their mind
- **Internal monologue**: 2-3 paragraphs in their voice, thinking through the option

### Decision-Making Approach

The persona uses whatever frameworks are natural to them:
- An analytical persona reasons through tradeoffs systematically
- An intuitive persona leads with gut feeling and rationalizes after
- A risk-averse persona focuses on what could go wrong
- A pragmatic persona asks "does this solve my problem today?"

Do NOT impose behavioral economics frameworks (prospect theory, endowment effect, etc.) unless they emerge naturally from the persona's stated psychology. The persona's behavioral economics profile from their background still applies, but it shapes HOW they think, not WHAT frameworks the simulation uses.

### Outcome Requirements

- At least 1 persona should be genuinely negative or indifferent
- At least 1 persona should have a strong concern that isn't addressed by the options
- Reactions should vary meaningfully across segments
- The persona's deal-breakers from their background must be honored

### Aggregate Analysis

In the synthesis, produce:
- **Reaction distribution**: How many personas were positive / negative / mixed for each option
