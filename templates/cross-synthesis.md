# Cross-Study Synthesis Instructions

You are producing a unified synthesis across multiple studies in a Facet behavioral simulation study. Each study tested a different aspect of the product with the SAME personas. Your job is to connect the findings, surface contradictions, and tell the story of how these simulated users responded to the product as a whole.

You have been given:
- Per-study synthesis files (each contains analysis, recommendations, and counterarguments for one study)
- Per-study artifacts files (actionable deliverables — copy, FAQ, objection scripts, validation plans)
...
Three paragraphs, written for a CEO or VP Product who hasn't read any individual study output. Answer: "We tested [product] with [N] simulated personas across [M] studies. Here's what we learned."

- Paragraph 1: The headline finding. What's the single most important thing this study revealed? Name it directly.
- Paragraph 2: The pattern across studies. What themes emerged consistently? What surprised?
...
### 2. Per-Study Key Findings

For each study, provide:
- **Study name** and what it tested
...
### 3. Cross-Study Themes

Identify 3-5 themes that appear across multiple studies. For each theme:
- **Theme name** (e.g., "Trust is the universal gating factor")
- **Which studies surface it** (reference by name)
- **How it manifests differently in each study**
...
### 4. Cross-Study Contradictions

Where do study findings disagree? For each contradiction:
...
For the 10-15 most interesting personas, track their journey across studies. Present as a table:

| ID | Name | Segment | Study 1 | Study 2 | ... | Arc Summary |
|----|------|---------|-----------|-----------|-----|-------------|

Then for each tracked persona, write a **full paragraph** explaining their arc. This is the most valuable section of the cross-synthesis — it turns simulated data points into human stories. The paragraph should connect their background (who they are, what they care about) to their journey across studies (how their reactions evolved or stayed consistent), ending with what archetype they represent. Example: "Greg Thompson (#9) was enthusiastic about the core concept but hostile to passive monitoring. Across 5 studies, he consistently valued transparency and control — any feature that removed human oversight was rejected. He represents the 'power user who wants AI as a tool, not a replacement' archetype."

Write at least 5 full-paragraph persona narratives. These are the stories that make the research memorable.

Select personas by:
- Strongest advocates (across studies, not just one)
- Strongest critics
- Most internally contradictory (positive in one study, negative in another)
- Most narratively interesting (their arc tells a story)
- Representing each major segment

### 6. Strategic Recommendations

Based on ALL studies together, what should the company do? Be specific:
- **Build first**: Which features/options/approaches were validated across studies?
- **Avoid or defer**: What was consistently rejected or low-confidence?
- **Segment targeting**: Which personas/segments should be targeted first, based on cross-study enthusiasm?
- **Messaging strategy**: What language and framing resonated across studies?
- **Risk watch list**: What could go wrong, based on the counterarguments from individual studies?

### 7. Confidence Assessment

Rate overall study confidence:
- **Findings that are robust** (appear across multiple studies, multiple segments, survive counterarguments)
...
- **Follow-up questions**: What new questions did the findings raise? Design studies to answer them.
- **Validation priorities**: Which fragile findings would benefit from a differently-framed study?

For each recommendation:
- **Study name and study type**
...
Recommend 2-4 studies. Be specific enough that someone could write the study config from your description.

### 9. Cross-Study Artifacts

Synthesize the most actionable deliverables from across all study artifacts files:

- **The single best positioning statement** (drawing from copy artifacts, concept reactions, and competitive findings)
- **Top 5 objections and responses** (deduplicated and ranked across studies)
- **Segment-specific go-to-market angles** (one sentence per segment, informed by all studies)
- **The referral stories that survived multiple studies** (which word-of-mouth narratives are consistent?)
...
- Note any studies where the synthesis flagged sycophancy or variance compression
...
- Quote from the per-study syntheses when possible. The individual studies already did deep analysis — build on it, don't redo it.
- Cross-study connections are the value. If you're just summarizing each study, you've failed. The insight is in the CONNECTIONS between studies.
